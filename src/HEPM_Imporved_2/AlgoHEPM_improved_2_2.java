 ...
 *         Souza
 */
public class AlgoHEPM_improved_2_2 {
...
//    	//======
	...
	private void backtrackingEFIM(List<Transaction> transactionsOfP, List<Integer> itemsToKeep,
			List<Integer> itemsToExplore, int SumOfInvest, int prefixLength,ArrayList<ArrayList<Integer>> PsetList) throws IOException {
...
//		        }
	 ...
	 * @param dataset the transaction database
	 */
	public void useUtilityBinArrayToCalculateSubtreeUtilityFirstTime(Dataset dataset,ArrayList<ArrayList<Integer>> PsetList) {
...
//			writer.newLine();
	...
	public void printStats() {
		...
		System.out.println("========== HEPM_Imporved_2_2 - STATS ============");
